...
var IIP = new Class({
  ...
  createWindows: function(){
    ...
    $('info').store('tip:text', '<h2><img src="images/iip.32x32.png"/>IIPMooViewer</h2>Visualizzatore Ajax di immagini IIP in alta risoluzione<ul><li>Per navigare l\'immagine:<ul><li>trascina l\'immagine nella finestra principale</li><li>trascina il riquadro nella finestra di navigazione</li><li>fai click nella finestra di navigazione</li></ul><li>Per ingrandire:<ul><li>doppio click con il mouse</li><li>premi il tasto "+"</li></ul><li>Per rimpicciolire:<ul><li>Shift + doppio click con il mouse</li><li>premi il tasto "-"</li></ul></li><li>Per muovere la finestra di navigazione:<ul><li>Trascina la barra superiore della finestra di navigazione</li></ul><li>Per mostrare / nascondere i pulsanti:</li><ul><li>fai doppio click sulla barra superiore della finestra di navigazione</li></ul></ul>Scritto da Ruven Pillay<br/>Per pi&ugrave; informazioni visita http://iipimage.sf.net');
  ...
  createNavigationWindow: function() {
    ...
    toolbar.store( 'tip:text', '* Trascina per muovere<br/>* Doppio click per mostrare/nascondere i pulsanti di navigazione' );
