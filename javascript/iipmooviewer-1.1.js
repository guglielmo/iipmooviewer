...
var IIP = new Class({
   ...
   */
    createNavigationWindow: function() {
        ...
        $('shiftLeft').addEvent('click',
        function() {
            this.scrollTo( - this.rgn_w / 3, 0);
        }.bind(this));
        $('shiftUp').addEvent('click',
        function() {
            this.scrollTo(0, -this.rgn_h / 3);
        }.bind(this));
        $('shiftDown').addEvent('click',
        function() {
            this.scrollTo(0, this.rgn_h / 3);
        }.bind(this));
        $('shiftRight').addEvent('click',
        function() {
            this.scrollTo(this.rgn_w / 3, 0);
        }.bind(this));
    ...
    load: function() {
        ...
        new Request(
        {
            ...
            onComplete: function(transport) {
                ...
                if (!tmp[1]) alert("Unexpected response from server " + this.server + ": " + response);
